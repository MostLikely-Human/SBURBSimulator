...
class RainClone extends Scene {
  ...
  void renderContent(Element div) {
    ...
    //rainyClone.denizen = this.original.getDenizen();//clones don't get their own denizen. hopefully, this wont exile the Original's Denizen... [Looks like Denizens tied to lands now]
